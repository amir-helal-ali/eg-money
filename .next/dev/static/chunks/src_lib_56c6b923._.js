...
const useAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        user: null,
        loading: false,
        initialized: false,
        settings: null,
...
function connectBalanceWS(userId) {
    ...
    balanceSocket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$socket$2e$io$2d$client$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["io"])(tickerUrl, {
        transports: [
            'websocket',
            'polling'
        ],
...
rawCountries.filter(([code])=>code === 'MZ2').map(([code, name, nameAr, dialCode])=>({
        ...
        dialCode,
        flag: flag('MG')
    }))).sort(_c = (a, b)=>a.code.localeCompare(b.code));
_c1 = COUNTRIES;
...
"[project]/src/lib/p2p-templates.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function renameTemplate(id, newLabel) {
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    const all = getTemplates().map((t)=>t.id === id ? {
            ...t,
            label: newLabel
        } : t);
    localStorage.setItem(STORAGE_KEY, JSON.stringify(all));
...
//# sourceMappingURL=src_lib_56c6b923._.js.map